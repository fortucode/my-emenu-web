            ...
            <li class="nav-item nav-profile dropdown">
              ...
              <div class="dropdown-menu navbar-dropdown dropdown-menu-right p-0 border-0 font-size-sm" aria-labelledby="profileDropdown" data-x-placement="bottom-end">
                ...
                <div class="p-2">
                  ...
                  <a class="dropdown-item py-1 d-flex align-items-center justify-content-between" href="{{route('profil.edit')}}">
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="idcombo">
                ...
                <!-- LES PROMOTIONS -->
            <li class="nav-item">
              <a class="nav-link" data-toggle="collapse" href="#idpromo" aria-expanded="false" aria-controls="ui-basic">
                <span class="icon-bg"><i class="mdi mdi-crosshairs-gps menu-icon"></i></span>
                <span class="menu-title">Gestion des promotions</span>
                <i class="menu-arrow"></i>
              </a>
              <div class="collapse" id="idpromo">
                <ul class="nav flex-column sub-menu">
            ...
            <footer class="footer">
                <div class="footer-inner-wraper">
                    <div class="d-sm-flex justify-content-center justify-content-sm-between">
                        <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © TopInfo 2025</span>
                            <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center"> Free <a href="https://www.bootstrapdash.com/" target="_blank">nbf.com</a> from NBF</span>
                    </div>
                </div>
            </footer>
          <!-- partial -->
